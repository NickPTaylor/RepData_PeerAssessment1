...
Using a similar approach to above, the data table is aggregate mean is computed by interval.  
```{r}
...
Here, we will 'correct' the missing data by substituting in the mean steps for that inteveal accross all of the days of collected data:
```{r}
# correction to data
step.data[, stepsCor := 
                ifelse(
